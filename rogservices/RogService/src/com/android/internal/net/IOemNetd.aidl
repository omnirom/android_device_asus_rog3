...
interface IOemNetd {
    ...
    * Add-on
    */
    void trafficLimitAddGameApp(int uid);
    void trafficLimitRemoveGameApp(int uid);
    void trafficLimitAddScreenOffApp(int uid);
    void trafficLimitRemoveScreenOffApp(int uid);
    void trafficLimitEnableChain(int tlChain, boolean enable);
}
