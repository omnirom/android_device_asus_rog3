...
public class Startup extends BroadcastReceiver {
    ...
    private static String SETTINGS_SYSTEM_CHARGING_INDICATOR_POLICY = "charging_indicator_policy";
    private static String SETTINGS_SYSTEM_LED_STATES = "led_states";
    private static String SETTINGS_SYSTEM_SYSTEM_EFFECT_ENABLED = "enable_system_effect";
    ...
    private void AddDefaultValue(Context context) {
        ...
        String value5 = Settings.Secure.getString(context.getContentResolver(), SETTINGS_SYSTEM_CHARGING_INDICATOR_POLICY);
        String value6 = Settings.Secure.getString(context.getContentResolver(), SETTINGS_SYSTEM_LED_STATES);
        String value7 = Settings.Secure.getString(context.getContentResolver(), SETTINGS_SYSTEM_SYSTEM_EFFECT_ENABLED);
        String value8 = Settings.Secure.getString(context.getContentResolver(), SYSTEM_SCALING_CONTROL);
        String value9 = Settings.Secure.getString(context.getContentResolver(), GAME_GENIE_SCALING_CONTROL);
        ...
        if (TextUtils.isEmpty(value)) {
            ...
            Settings.Secure.putString(context.getContentResolver(), SETTINGS_SYSTEM_CHARGING_INDICATOR_POLICY, initialValue);
        } else if (TextUtils.isEmpty(value6)) {
            Settings.Secure.putString(context.getContentResolver(), SETTINGS_SYSTEM_LED_STATES, initialValue);
        } else if (TextUtils.isEmpty(value7)) {
            Settings.Secure.putString(context.getContentResolver(), SETTINGS_SYSTEM_SYSTEM_EFFECT_ENABLED, initialValue);
